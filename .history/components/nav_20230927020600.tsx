...
const Nav = () => {
  ...
  return (
    <div className="flex w-screen py-6 px-6 items-center">
      ...
      <div className="flex text-sm items-center text-white/50 h-max w-max py-1 px-3 border border-white/50 rounded-xl">
        <p>Get Started</p>
      </div>
    </div>
  );
